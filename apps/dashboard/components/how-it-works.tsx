...
const steps = [
  ...
  },
  {
    ...
    description:
      "The identical composite is broadcast under an idempotency key. The guard asserts post-state at inclusion, so if state moves between preflight and inclusion, the transaction reverts instead of doing damage.",
  },
];
      ...
      <div className="mx-auto grid max-w-5xl gap-12 px-6 py-20 sm:py-28 lg:grid-cols-2 lg:gap-20">
        <div className="lg:sticky lg:top-48 lg:h-fit lg:self-start">
          ...
          <p className="mt-6 max-w-md text-lg leading-relaxed text-foreground/60">
            ...
            atomically when it does — prediction and enforcement are{" "}
            <span className="font-medium text-foreground">the same code path</span>.
          </p>
          <motion.a
            href="/execute"
