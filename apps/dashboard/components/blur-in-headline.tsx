...
const headline =
  "The refusal happens before the transaction exists. Calldata is what the agent claims it will do; the guard enforces what the chain says will happen — same contract, same function, same arguments, only the consequence differs.";
